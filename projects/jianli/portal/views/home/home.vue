    ...
    <div class="content"
        ...
        <div class="cv-container">
            <div id="section1" class="section active">
                <div id="top" title="顶部">
                    <img src="@portal/images/top.png" alt="回到顶部">
                </div>
                <div class="myIntro">
            ...
            <div class="section demo-section">
                ...
                <div class="container center fades">
                    ...
                    <div class="col-md-3 col-xs-6" @click="openDemoPage('yanhua.html')">
                        <div class="imgbox">
                            <img src="@portal/images/05.jpg" alt="作品配图">
                        </div>
                        <a href="javascript:void(0)">
                    ...
                    <div class="col-md-3 col-xs-6" @click="openDemoPage('caihongpp.html')">
                        <div class="imgbox">
                            <img src="@portal/images/05.jpg" alt="作品配图">
                        </div>
                        <a href="javascript:void(0)">
            ...
            <div class="section demo-section">
                ...
                <div class="container center fades">
                    ...
                    <div class="col-md-3 col-xs-6" @click="stateGo('faceDetect')">
                        <div class="imgbox">
                            <img src="@portal/images/05.jpg" alt="作品配图">
                        </div>
                        <a href="javascript:void(0)">
                            <div class="zp-cover">
                                <h4>人脸识别</h4>
                                <p>cropper+webcam+百度AI实现人脸识别功能</p>
                                <img src="@portal/images/search.png" alt="查看">
                            </div>
                        </a>
                    </div>
            ...
            <div class="section demo-section">
                ...
                <div class="container center fades">
                    ...
                    <div class="col-md-3 col-xs-6" @click="stateGo('demo-validationPlugin')">
                        <div class="imgbox">
                            <img src="@portal/images/01.jpg" alt="作品配图">
                        </div>
                        <a href="javascript:void(0)">
            ...
            <div id="section6" class="section">
                <h2 class="scroll-mvvm">MVVM框架掌握</h2>
                <hr>
                <div class="container center fades">
