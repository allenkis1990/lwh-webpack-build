...
//let findRightIndexHtml = require('./task/findRightIndexHtml.js')
//index.html找不到的时候去找parentProject
//findRightIndexHtml(config)
...
module.exports = {
    entry: {
        portalEntry: `${config.projectPath}/${config.portal}/js/index.js`,
        centerEntry: `${config.projectPath}/${config.center}/js/index.js`
    },
    output:{
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            template:`${config.projectPath}/${config.portal}/index.html`,//INdex的模板
            inject: true,
            //hash:true,
            title:'portal',
            minify: {
        ...
        new HtmlWebpackPlugin({
            ...
            template:`${config.projectPath}/${config.center}/index.html`,//INdex的模板
            inject: true,
            //hash:true,
            title:'center',
            minify: {
